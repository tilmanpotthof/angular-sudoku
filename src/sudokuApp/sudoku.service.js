/* eslint complexity: [1, 5], max-statements: [1, 20] */
angular.module('sudokuApp')
  .factory('sudokuService', function (createUUID, $log, sudokuStorage) {
    'use strict';
    function SudokuField(value, x, y) {
      angular.extend(this, {x: x, y: y, _value: value, fixedValue: 1 <= value && value <= 9});//eslint-disable-line yoda
    }

    //@ http://jsfromhell.com/array/shuffle [v1.0]
    function shuffle(o) { //v1.0
      for (var j, x, i = o.length; i; // eslint-disable-line curly
    ...
    Sudoku.prototype = {
      ...
      solveLogic: function () {
        ...
        this.visit(function (field) {
          ...
          if (possibilities.length > 1) {
            $log.log(field.x, field.y, possibilities);
          }
        });
      },
