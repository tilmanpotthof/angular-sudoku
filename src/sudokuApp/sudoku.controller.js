angular.module('sudokuApp')
  .controller('sudokuController', function ($scope, sudokuService, sudokuView, sudokuStorage, measureTime, $location) {
    'use strict';
    ...
    $scope.removeSudoku = function () {
      var confirmMessage = 'Möchten Sie das Sudoku "' + $scope.currentSudoku.name + '" wirklich löschen?';
      if ($scope.currentSudoku.editable && confirm(confirmMessage)) { // eslint-disable-line no-alert
